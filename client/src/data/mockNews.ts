...
export const mockNews: News[] = [
  {
    ...
    content: `
      ...
      <p>DatVe360 vui mừng thông báo khai trương tuyến xe mới Hồ Chí Minh - Phan Thiết, phục vụ nhu cầu du lịch biển của quý khách.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Chào mừng tháng 11, DatVe360 tri ân khách hàng với chương trình giảm giá đặc biệt.</p>
      ...
      <ol>
        <li>Đặt vé trực tuyến tại website DatVe360.vn</li>
  ...
  },
  {
    ...
    content: `
      <h2>Ra mắt ứng dụng DatVe360 - Đặt vé xe bus thông minh</h2>
      <p>DatVe360 chính thức ra mắt ứng dụng di động, mang đến trải nghiệm đặt vé nhanh chóng và tiện lợi hơn bao giờ hết.</p>
